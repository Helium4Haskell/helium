...
sem_TypingStrategy_TypingStrategy (typerule_) (statements_) =
    let _lhsOcore :: (Core_TypingStrategy)
        ...
        ( _typeruleIconclusionType,_typeruleIcore,_typeruleIself,_typeruleIsimpleJudgements,_typeruleItypevariables) =
...
type T_UserStatement = ([((String, Maybe String), MessageBlock)]) ->
                       ...
                       ( (Core_UserStatement),(Names),(UserStatement),(Names),(TypeConstraints ConstraintInfo))
-- cata
...
type T_UserStatements = ([((String, Maybe String), MessageBlock)]) ->
                        ...
                        (((Tp, Tp) -> ConstraintInfo)) ->
                        (TypeConstraints ConstraintInfo) ->
                        ( (Core_UserStatements),(Names),(UserStatements),(Names),(TypeConstraints ConstraintInfo))
-- cata
    ...
    \ _lhsIattributeTable
      ...
      _lhsIuserConstraints ->
        let _lhsOcore :: (Core_UserStatements)
            ...
            ( _hdIcore,_hdImetaVariableConstraintNames,_hdIself,_hdItypevariables,_hdIuserConstraints) =
