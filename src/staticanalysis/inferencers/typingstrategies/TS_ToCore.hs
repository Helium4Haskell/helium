...
sem_Judgement_Judgement (expression_) (type_) =
    \ _lhsInameMap ->
        let ( _expressionIself) =
            ...
            (_lhsOself@_) =
                _self
        in  ( _lhsOconclusionType,_lhsOcore,_lhsOself,_lhsOtypevariables)
-- LeftHandSide ------------------------------------------------
-- semantic domain
...
sem_SimpleJudgements_Cons (hd_) (tl_) =
    \ _lhsInameMap
      _lhsIsimpleJudgements ->
        let ( _hdIcore,_hdIself,_hdIsimpleJudgements,_hdItypevariables) =
...
sem_TypeRule_TypeRule (premises_) (conclusion_) =
    \ _lhsInameMap
      _lhsIsimpleJudgements ->
        let ( _premisesIcore,_premisesIself,_premisesIsimpleJudgements,_premisesItypevariables) =
                (premises_ (_premisesOnameMap) (_premisesOsimpleJudgements))
            ( _conclusionIconclusionType,_conclusionIcore,_conclusionIself,_conclusionItypevariables) =
            ...
            (_conclusionOnameMap@_) =
                _lhsInameMap
        in  ( _lhsOconclusionType,_lhsOcore,_lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables)
-- Types -------------------------------------------------------
-- semantic domain
...
sem_TypingStrategy_TypingStrategy (typerule_) (statements_) =
    let ( _typeruleIconclusionType,_typeruleIcore,_typeruleIself,_typeruleIsimpleJudgements,_typeruleItypevariables) =
            (typerule_ (_typeruleOnameMap) (_typeruleOsimpleJudgements))
        ( _statementsIcore,_statementsImetaVariableConstraintNames,_statementsIself,_statementsItypevariables,_statementsIuserConstraints) =
        ...
        (_lhsOcore@_) =
            TypingStrategy _typeruleIcore _statementsIcore
        ...
        let ( _leftTypeIself,_leftTypeItypevariables) =
            ...
            (_lhsOcore@_) =
                Constraint
                  ...
                  (concat (substituteAttributes (algebraFromNameMap _lhsInameMap) message_))
            (_newConstraint@_) =
            ...
            (_lhsOmetaVariableConstraintNames@_) =
                _lhsImetaVariableConstraintNames
        in  ( _lhsOcore,_lhsOmetaVariableConstraintNames,_lhsOself,_lhsOtypevariables,_lhsOuserConstraints)
...
sem_UserStatements_Cons (hd_) (tl_) =
    \ _lhsIattributeTable
      ...
      _lhsIstandardConstraintInfo
      _lhsIuserConstraints ->
        let ( _hdIcore,_hdImetaVariableConstraintNames,_hdIself,_hdItypevariables,_hdIuserConstraints) =
                (hd_ (_hdOattributeTable) (_hdOmetaVariableConstraintNames) (_hdOnameMap) (_hdOstandardConstraintInfo) (_hdOuserConstraints))
            ( _tlIcore,_tlImetaVariableConstraintNames,_tlIself,_tlItypevariables,_tlIuserConstraints) =
