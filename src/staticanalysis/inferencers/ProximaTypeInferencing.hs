...
sem_Alternative_Alternative (_range)
    ...
    let (_self) =
        ...
        (_typeEnvPrx) =
            _pattern_typeEnvPrx ++ _righthandside_typeEnvPrx
...
sem_Constructor_Constructor (_range) (_constructor) (_types) (_lhs_namesInScope) =
    let (_self) =
        ...
        ( _range_self) =
            (_range )
        ( _constructor_isIdentifier,_constructor_isOperator,_constructor_isSpecial,_constructor_oneLineTree,_constructor_self,_constructor_typeEnvPrx) =
            (_constructor )
...
sem_Name_Identifier (_range) (_module) (_name) =
    let (_self) =
        ...
        ( _module_oneLineTree,_module_self) =
            (_module )
    in  ( True,False,False,_oneLineTree,_self,_typeEnvPrx)
...
sem_Name_Operator (_range) (_module) (_name) =
    let (_self) =
        ...
        ( _module_oneLineTree,_module_self) =
            (_module )
    in  ( False,True,False,_oneLineTree,_self,_typeEnvPrx)
...
sem_Name_Special (_range) (_module) (_name) =
    let (_self) =
        ...
        ( _module_oneLineTree,_module_self) =
            (_module )
    in  ( False,False,True,_oneLineTree,_self,_typeEnvPrx)
-- Names -------------------------------------------------------
-- semantic domain
...
sem_Names_Cons (_hd) (_tl) =
    let (_self) =
            (:) _hd_self _tl_self
        ( _hd_isIdentifier,_hd_isOperator,_hd_isSpecial,_hd_oneLineTree,_hd_self,_hd_typeEnvPrx) =
            (_hd )
...
sem_Pattern_Literal (_range) (_literal) (_lhs_betaUnique) (_lhs_importEnvironment) (_lhs_namesInScope) (_lhs_patternMatchWarnings) (_lhs_substitution) =
    let (_self) =
        ...
        ( _literal_elements,_literal_literalType,_literal_oneLineTree,_literal_self) =
            (_literal )
    in  ( _beta,_lhs_betaUnique + 1,unitTree ((_literal_literalType .==. _beta) _cinfo),_literal_elements,noAssumptions,_oneLineTree,[],_lhs_patternMatchWarnings,_self,_typeEnvPrx,[])
...
sem_Pattern_Negate (_range) (_literal) (_lhs_betaUnique) (_lhs_importEnvironment) (_lhs_namesInScope) (_lhs_patternMatchWarnings) (_lhs_substitution) =
    let (_self) =
        ...
        ( _literal_elements,_literal_literalType,_literal_oneLineTree,_literal_self) =
            (_literal )
    in  ( _beta,_lhs_betaUnique + 1,listTree _newcon,_literal_elements,noAssumptions,_oneLineTree,[],_lhs_patternMatchWarnings,_self,_typeEnvPrx,[])
...
sem_Pattern_Successor (_range) (_name) (_literal) (_lhs_betaUnique) (_lhs_importEnvironment) (_lhs_namesInScope) (_lhs_patternMatchWarnings) (_lhs_substitution) =
    let (_self) =
        ...
        ( _literal_elements,_literal_literalType,_literal_oneLineTree,_literal_self) =
            (_literal )
    in  ( _beta,_lhs_betaUnique,_constraints,pmError "Pattern_Successor.elements" "Successors are not supported",_environment,_oneLineTree,[],_lhs_patternMatchWarnings,_self,_typeEnvPrx,[])
...
sem_Pattern_Wildcard (_range) (_lhs_betaUnique) (_lhs_importEnvironment) (_lhs_namesInScope) (_lhs_patternMatchWarnings) (_lhs_substitution) =
    let (_self) =
        ...
        ( _range_self) =
            (_range )
    in  ( _beta,_lhs_betaUnique + 1,emptyTree,[WildcardElement],noAssumptions,_oneLineTree,[],_lhs_patternMatchWarnings,_self,_typeEnvPrx,[])
-- Patterns ----------------------------------------------------
-- semantic domain
type T_Patterns = (Int) ->
                  (ImportEnvironment) ->
...
sem_Patterns_Nil (_lhs_betaUnique) (_lhs_importEnvironment) (_lhs_namesInScope) (_lhs_patternMatchWarnings) (_lhs_substitution) =
    let (_self) =
        ...
        (_typeEnvPrx) =
            []
    in  ( _lhs_betaUnique,[],[],[],noAssumptions,0,[],[],_lhs_patternMatchWarnings,_self,_typeEnvPrx,[])
-- Position ----------------------------------------------------
-- semantic domain
