...
-- UUAGC 0.9.40.3 (StaticAnalysis/Directives/TS_Analyse.ag)
...
wrap_Expression sem (Inh_Expression) =
    (let ( _lhsOallVariables,_lhsOself) = sem
     in  (Syn_Expression _lhsOallVariables _lhsOself))
...
sem_Expression_Enum range_ from_ then_ to_ =
    (let _lhsOallVariables :: ([(Name,Entity)])
         ...
         ( _fromIallVariables,_fromIself) =
             from_
         ( _thenIallVariables,_thenIself) =
             then_
         ( _toIallVariables,_toIself) =
             to_
     in  ( _lhsOallVariables,_lhsOself))
...
sem_Expression_If range_ guardExpression_ thenExpression_ elseExpression_ =
    (let _lhsOallVariables :: ([(Name,Entity)])
         ...
         ( _guardExpressionIallVariables,_guardExpressionIself) =
             guardExpression_
         ( _thenExpressionIallVariables,_thenExpressionIself) =
             thenExpression_
         ( _elseExpressionIallVariables,_elseExpressionIself) =
             elseExpression_
     in  ( _lhsOallVariables,_lhsOself))
...
sem_Expression_InfixApplication range_ leftExpression_ operator_ rightExpression_ =
    (let _lhsOallVariables :: ([(Name,Entity)])
         ...
         ( _leftExpressionIallVariables,_leftExpressionIself) =
             leftExpression_
         ( _operatorIallVariables,_operatorIself) =
             operator_
         ( _rightExpressionIallVariables,_rightExpressionIself) =
             rightExpression_
     in  ( _lhsOallVariables,_lhsOself))
...
sem_Expression_NormalApplication range_ function_ arguments_ =
    (let _lhsOallVariables :: ([(Name,Entity)])
         ...
         ( _functionIallVariables,_functionIself) =
             function_
         ( _argumentsIallVariables,_argumentsIself) =
             arguments_
     in  ( _lhsOallVariables,_lhsOself))
...
wrap_Expressions sem (Inh_Expressions) =
    (let ( _lhsOallVariables,_lhsOself) = sem
     in  (Syn_Expressions _lhsOallVariables _lhsOself))
...
wrap_Judgement sem (Inh_Judgement _lhsInameMap) =
    (let ( _lhsOallVariables,_lhsOconclusionType,_lhsOself,_lhsOtheExpression,_lhsOtypevariables) = sem _lhsInameMap
     in  (Syn_Judgement _lhsOallVariables _lhsOconclusionType _lhsOself _lhsOtheExpression _lhsOtypevariables))
...
sem_Judgement_Judgement expression_ type_ =
    (\ _lhsInameMap ->
         (let _lhsOconclusionType :: Tp
              ...
              ( _typeIself,_typeItypevariables) =
                  type_
          in  ( _lhsOallVariables,_lhsOconclusionType,_lhsOself,_lhsOtheExpression,_lhsOtypevariables)))
-- LeftHandSide ------------------------------------------------
-- cata
...
wrap_MaybeExpression sem (Inh_MaybeExpression) =
    (let ( _lhsOallVariables,_lhsOself) = sem
     in  (Syn_MaybeExpression _lhsOallVariables _lhsOself))
...
wrap_SimpleJudgement sem (Inh_SimpleJudgement _lhsInameMap _lhsIsimpleJudgements) =
    (let ( _lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables) = sem _lhsInameMap _lhsIsimpleJudgements
     in  (Syn_SimpleJudgement _lhsOself _lhsOsimpleJudgements _lhsOtypevariables))
    ...
    (\ _lhsInameMap
       _lhsIsimpleJudgements ->
         (let _lhsOsimpleJudgements :: ([(String,Tp)])
              ...
              ( _typeIself,_typeItypevariables) =
                  type_
          in  ( _lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables)))
-- SimpleJudgements --------------------------------------------
-- cata
...
wrap_SimpleJudgements sem (Inh_SimpleJudgements _lhsInameMap _lhsIsimpleJudgements) =
    (let ( _lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables) = sem _lhsInameMap _lhsIsimpleJudgements
     in  (Syn_SimpleJudgements _lhsOself _lhsOsimpleJudgements _lhsOtypevariables))
...
wrap_TypeRule sem (Inh_TypeRule _lhsInameMap _lhsIsimpleJudgements) =
    (let ( _lhsOconclusionAllVariables,_lhsOconclusionExpression,_lhsOconclusionType,_lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables) = sem _lhsInameMap _lhsIsimpleJudgements
     in  (Syn_TypeRule _lhsOconclusionAllVariables _lhsOconclusionExpression _lhsOconclusionType _lhsOself _lhsOsimpleJudgements _lhsOtypevariables))
    ...
    (\ _lhsInameMap
       _lhsIsimpleJudgements ->
         (let _lhsOconclusionAllVariables :: ([(Name,Entity)])
          ...
          in  ( _lhsOconclusionAllVariables,_lhsOconclusionExpression,_lhsOconclusionType,_lhsOself,_lhsOsimpleJudgements,_lhsOtypevariables)))
-- Types -------------------------------------------------------
-- cata
sem_Types :: Types ->
             T_Types
...
wrap_TypingStrategies sem (Inh_TypingStrategies) =
    (let ( _lhsOself) = sem
...
wrap_TypingStrategy sem (Inh_TypingStrategy _lhsIimportEnvironment) =
    (let ( _lhsOerrors,_lhsOself,_lhsOwarnings) = sem _lhsIimportEnvironment
     in  (Syn_TypingStrategy _lhsOerrors _lhsOself _lhsOwarnings))
...
sem_TypingStrategy_Siblings names_ =
    (\ _lhsIimportEnvironment ->
         (let _lhsOerrors :: TS_Errors
              ...
              ( _namesIself) =
                  names_
          in  ( _lhsOerrors,_lhsOself,_lhsOwarnings)))
...
wrap_UserStatement sem (Inh_UserStatement _lhsIattributeTable _lhsImetaVariableConstraintNames _lhsInameMap _lhsIstandardConstraintInfo _lhsIuserConstraints _lhsIuserPredicates) =
    (let ( _lhsOmetaVariableConstraintNames,_lhsOself,_lhsOtypevariables,_lhsOuserConstraints,_lhsOuserPredicates) = sem _lhsIattributeTable _lhsImetaVariableConstraintNames _lhsInameMap _lhsIstandardConstraintInfo _lhsIuserConstraints _lhsIuserPredicates
     in  (Syn_UserStatement _lhsOmetaVariableConstraintNames _lhsOself _lhsOtypevariables _lhsOuserConstraints _lhsOuserPredicates))
...
wrap_UserStatements sem (Inh_UserStatements _lhsIattributeTable _lhsImetaVariableConstraintNames _lhsInameMap _lhsIstandardConstraintInfo _lhsIuserConstraints _lhsIuserPredicates) =
    (let ( _lhsOmetaVariableConstraintNames,_lhsOself,_lhsOtypevariables,_lhsOuserConstraints,_lhsOuserPredicates) = sem _lhsIattributeTable _lhsImetaVariableConstraintNames _lhsInameMap _lhsIstandardConstraintInfo _lhsIuserConstraints _lhsIuserPredicates
     in  (Syn_UserStatements _lhsOmetaVariableConstraintNames _lhsOself _lhsOtypevariables _lhsOuserConstraints _lhsOuserPredicates))
