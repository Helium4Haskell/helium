...
-- UUAGC 0.9.40.3 (ModuleSystem/ExtractImportDecls.ag)
...
wrap_Body sem (Inh_Body) =
    (let ( _lhsOcoreImportDecls,_lhsOself) = sem
     in  (Syn_Body _lhsOcoreImportDecls _lhsOself))
...
wrap_FunctionBinding sem (Inh_FunctionBinding) =
    (let ( _lhsOname,_lhsOself) = sem
     in  (Syn_FunctionBinding _lhsOname _lhsOself))
...
sem_FunctionBinding_Feedback range_ feedback_ functionBinding_ =
    (let _lhsOself :: FunctionBinding
         ...
         ( _rangeIself) =
             range_
         ( _functionBindingIname,_functionBindingIself) =
             functionBinding_
...
wrap_FunctionBindings sem (Inh_FunctionBindings) =
    (let ( _lhsOname,_lhsOself) = sem
     in  (Syn_FunctionBindings _lhsOname _lhsOself))
...
wrap_Import sem (Inh_Import) =
    (let ( _lhsOimps,_lhsOself) = sem
     in  (Syn_Import _lhsOimps _lhsOself))
...
wrap_ImportDeclaration sem (Inh_ImportDeclaration) =
    (let ( _lhsOcoreImportDecls,_lhsOself) = sem
     in  (Syn_ImportDeclaration _lhsOcoreImportDecls _lhsOself))
...
wrap_ImportDeclarations sem (Inh_ImportDeclarations) =
    (let ( _lhsOcoreImportDecls,_lhsOself) = sem
     in  (Syn_ImportDeclarations _lhsOcoreImportDecls _lhsOself))
...
wrap_ImportSpecification sem (Inh_ImportSpecification) =
    (let ( _lhsOimps,_lhsOself) = sem
     in  (Syn_ImportSpecification _lhsOimps _lhsOself))
...
wrap_Imports sem (Inh_Imports) =
    (let ( _lhsOimps,_lhsOself) = sem
     in  (Syn_Imports _lhsOimps _lhsOself))
...
wrap_LeftHandSide sem (Inh_LeftHandSide) =
    (let ( _lhsOname,_lhsOself) = sem
     in  (Syn_LeftHandSide _lhsOname _lhsOself))
...
wrap_MaybeImportSpecification sem (Inh_MaybeImportSpecification) =
    (let ( _lhsOimps,_lhsOself) = sem
     in  (Syn_MaybeImportSpecification _lhsOimps _lhsOself))
...
wrap_Module sem (Inh_Module) =
    (let ( _lhsOcoreImportDecls,_lhsOself) = sem
     in  (Syn_Module _lhsOcoreImportDecls _lhsOself))
