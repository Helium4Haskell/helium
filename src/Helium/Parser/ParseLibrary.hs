...
lexCLASS, lexINSTANCE, lexDATA, lexDERIVING, lexTYPE, lexNEWTYPE, lexLET, lexIN, lexDO, lexIF, lexTHEN, lexELSE, lexCASE, lexOF, lexMODULE, lexWHERE, lexIMPORT, lexHIDING, lexINFIX, lexINFIXL, lexINFIXR, lexUNDERSCORE :: HParser ()
...
lexNEWTYPE  = lexeme (LexKeyword "newtype")
