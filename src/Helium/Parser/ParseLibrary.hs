...
lexCLASS, lexINSTANCE, lexFAMILY, lexDATA, lexDERIVING, lexTYPE, lexLET, lexIN, lexDO, lexIF, lexTHEN, lexELSE, lexCASE, lexOF, lexMODULE, lexWHERE, lexIMPORT, lexHIDING, lexINFIX, lexINFIXL, lexINFIXR, lexUNDERSCORE :: HParser ()
lexCLASS    = lexeme (LexKeyword "class")
lexINSTANCE = lexeme (LexKeyword "instance")
lexFAMILY   = lexeme (LexKeyword "family")
