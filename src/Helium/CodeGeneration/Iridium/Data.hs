...
data AbstractMethod = AbstractMethod !Type !FunctionType !FFIInfo ![Annotation]
  deriving (Eq, Ord)

data FFIInfo = FFIInfo (Maybe String)
  deriving (Eq, Ord)

abstractFunctionType :: AbstractMethod -> FunctionType
abstractFunctionType (AbstractMethod _ tp _ _) = tp
