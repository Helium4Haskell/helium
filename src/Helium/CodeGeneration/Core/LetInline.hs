...
isShort allowAp (Forall _ e) = isShort allowAp e
...
isUnsaturatedCall arities (Forall _ e) consumed = isUnsaturatedCall arities e consumed
...
inlineInExpr env (Forall q e) = Forall q $ inlineInExpr env e
